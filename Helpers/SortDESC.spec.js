...
describe("Sorting Products by Size in DESC format", () => {
  const products = [
    {
  ...
  it("should sort in descending sort on size property", () => {
    expect(SortDESC(products, "size")).toEqual(sortedBySize);
  });
  it("should sort in descending sort on price property", () => {
    expect(SortDESC(products, "price")).toEqual(sortedByPrice);
  });
});
